...
flat_state_t cpu_get_flat_state(void)
{
	...
	saveState.clk_timer_2hz_timestamp = *cpu_state.clk_timer_2hz_timestamp;
	saveState.clk_timer_4hz_timestamp = *cpu_state.clk_timer_4hz_timestamp;
	saveState.clk_timer_8hz_timestamp = *cpu_state.clk_timer_8hz_timestamp;
	saveState.clk_timer_16hz_timestamp = *cpu_state.clk_timer_16hz_timestamp;
	saveState.clk_timer_32hz_timestamp = *cpu_state.clk_timer_32hz_timestamp;
	saveState.clk_timer_64hz_timestamp = *cpu_state.clk_timer_64hz_timestamp;
	saveState.clk_timer_128hz_timestamp =*cpu_state.clk_timer_128hz_timestamp;
	saveState.clk_timer_256hz_timestamp =*cpu_state.clk_timer_256hz_timestamp;
